...
Locales["de_lang"] = {
    ...
    booster_desc              = "Admin booster",
    database_desc             = "Zugriff Datenbank",
    teleport_desc             = "Teleport ",
    confirm                   = "Bestätigen", -- for all inputs
    empty                     = "ist leer", --for all inputs
    MenuTitle_desc            = "Spieler Manegement",
    SimpleAction              = "einfache Aktionen",
    AdvancedAction            = "erweiterte Aktionen",
    ------------------------------------------------
    -- Player status
    SteamName                 = "Steam Name: ",
    ServerID                  = "Server ID: ",
    PlayerGroup               = "Spieler Gruppe: ",
    PlayerJob                 = "Spieler Job: ",
    Grade                     = "Grade: ",
    Identifier                = "Identifier: ",
    PlayerMoney               = "Spieler Geld: ",
    PlayerGold                = "Spieler Gold: ",
    PlayerStaticID            = "Spieler Static ID: ",
    PlyaerWhitelist           = "Spieler Is whitelist: ",
    PlayerWarnings            = "Spieler warnings: ",
    ------------------------------------------------
    -- submenu ADMIN ACTIONS
    MenuSubtitle2             = "Spieler online",
    kick_p                    = "Kick",
